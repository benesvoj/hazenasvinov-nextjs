        ...
        return (
          <div className="flex flex-col items-center justify-center min-h-[200px] p-6 text-center">
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 max-w-md">
              ...
              <h3 className="text-lg font-semibold text-yellow-800 mb-2">Chunk Loading Error</h3>
              <p className="text-sm text-yellow-700 mb-4">
                There was an issue loading some components. The page will reload automatically to
                fix this.
              </p>
              <div className="animate-pulse">
                <div className="text-xs text-yellow-600">Reloading in 1 second...</div>
              </div>
            </div>
          </div>
        );
