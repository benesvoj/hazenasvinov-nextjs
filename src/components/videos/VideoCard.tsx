...
import {PlayIcon, PencilIcon, TrashIcon, LinkIcon} from '@heroicons/react/24/outline';
...
export function VideoCard({video, onEdit, onDelete, categories, seasons}: VideoCardProps) {
