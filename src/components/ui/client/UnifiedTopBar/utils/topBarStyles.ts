...
export const VARIANT_CONFIG = {
  [PortalVariant.ADMIN]: {zIndex: 'z-40', contentClass: 'h-full px-3 sm:px-4 xl:px-6'},
  [PortalVariant.COACH]: {zIndex: 'z-30', contentClass: 'px-3 sm:px-4 py-3'},
};
...
export const getHeaderClasses = (variant: PortalVariant, sidebar?: SidebarState): string => {
...
export const getContentClasses = (variant: PortalVariant): string => {
