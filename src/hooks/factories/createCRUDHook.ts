 ...
 *   baseEndpoint: API_ROUTES.committees.root or API_ROUTES.entities.root('committees'),
 *   byIdEndpoint: API_ROUTES.committees.byId or (id) => API_ROUTES.entities.byId('committees', id),
