  ...
  describe('Request Cancellation', () => {
    it('should cancel pending request on unmount', async () => {
      ...
      const mockAbortController = {
        abort: abortSpy,
        signal: new originalAbortController().signal, // Use original to avoid recursion
      };
    ...
    it('should cancel previous request when refetch is called', async () => {
      ...
      global.AbortController = vi.fn(() => {
        abortController = {
          abort: abortSpy,
          signal: new originalAbortController().signal, // Use original to avoid infinite recursion
        };
