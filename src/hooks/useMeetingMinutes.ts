...
export function useMeetingMinutes() {
  ...
  const createMeetingMinutes = useCallback(async (formData: any) => {
    try {
      setLoading(true);
      setError(null);
  ...
  const updateMeetingMinutes = useCallback(async (id: string, formData: any) => {
    try {
      setLoading(true);
      setError(null);
  ...
  const deleteMeetingMinutes = useCallback(async (id: string) => {
    try {
      setLoading(true);
      setError(null);
