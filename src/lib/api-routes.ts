 ...
 * Generated at: 2025-11-12T16:13:09.040Z
 *
...
export const API_ROUTES = {
  ...
  committees: {
    root: '/api/committees' as const,
    byId: (id: string | number) => `/api/committees/${id}`,
  },
  dev: {
  ...
  seasons: {
    root: '/api/seasons' as const,
    byId: (id: string | number) => `/api/seasons/${id}`,
  },
  sponsorship: {
