  ...
  public: {
    ...
    Functions: {
      ...
      get_attendance_trends: {
        Args: {p_category_id: string; p_days?: number; p_season_id: string};
        Returns: {
          absent_count: number;
          attendance_percentage: number;
          excused_count: number;
      ...
      refresh_attendance_statistics_summary: {Args: never; Returns: undefined};
      ...
      scheduled_refresh_attendance_stats: {Args: never; Returns: undefined};
