...
const CategorySimulationProvider = createContext<AdminCategorySimulationContextType | undefined>(
  undefined
);
...
export function AdminCategorySimulationProvider({children}: {children: React.ReactNode}) {
  ...
  return (
    <CategorySimulationProvider.Provider
      value={{
        selectedCategories,
        availableCategories,
        selectCategory,
...
export function useAdminCategorySimulation() {
  const context = useContext(CategorySimulationProvider);
