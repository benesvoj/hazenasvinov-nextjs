...
export const releaseNotes: ReleaseNote[] = [
  {
    ...
    improvements: [
      ...
      '📱 User Experience - Improved category selection with auto-selection for single categories',
    ...
    bugFixes: [
      ...
      '📊 Resolved database view dependencies on removed categories.code column',
