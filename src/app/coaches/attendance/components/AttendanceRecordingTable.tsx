...
import {Alert, Button, Table, TableBody, TableCell, TableColumn, TableHeader, TableRow,} from '@heroui/react';
...
export const AttendanceRecordingTable = ({
	...
	return (
		<ContentCard isLoading={loading} title={cardTitle} subtitle={cardSubtitle}>
			{!selectedSession ? (
