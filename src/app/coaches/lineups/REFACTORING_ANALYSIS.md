...
return {
    lineups,  // ⚠️ But page.tsx never uses this!
    // ...
};
```
...
- [ ] **Task 2.3:** Update page.tsx if needed
...
**Goal:** Reduce page.tsx from 512 to <250 lines
...
├── page.tsx (< 250 lines - orchestrator only)
├── components/
