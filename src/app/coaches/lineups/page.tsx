...
import {CategoryLineup, CreateCategoryLineupMemberModal, UpdateCategoryLineupMember} from '@/types';
...
export default function CoachesLineupsPage() {
  ...
  const {loading, error, createLineup, updateLineup, deleteLineup} = useCategoryLineups();
