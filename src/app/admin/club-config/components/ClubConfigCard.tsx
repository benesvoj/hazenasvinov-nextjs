...
import { BuildingOfficeIcon, EnvelopeIcon, GlobeAltIcon, MapPinIcon, PhoneIcon, PhotoIcon } from "@heroicons/react/24/outline";
										...
										<div className="flex items-center gap-3">
											{formData.club_logo_url ? (
												<Logo
													...
													fallbackSrc={formData.club_logo_url}
												/>
											) : (
									...
									<div className="flex items-center gap-3">
										{clubConfig?.club_logo_url ? (
											<Logo
												size="md"
												className="rounded-lg"
												fallbackSrc={clubConfig.club_logo_url}
											/>
										) : (
											<div className="w-12 h-12 bg-gray-200 rounded-lg flex items-center justify-center">
												<PhotoIcon className="w-6 h-6 text-gray-400" />
