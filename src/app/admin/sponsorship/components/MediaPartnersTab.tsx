...
export const MediaPartnersTab = () => {
  ...
  const getCoverageBadge = (coverage: string) => {
    ...
    return (
      <Badge
        className={
          coverageColors[coverage as keyof typeof coverageColors] || 'bg-gray-100 text-gray-800'
        }
      >
        ...
        <div className="flex justify-between w-full items-center">
          <div>
            ...
            <p className="text-sm text-gray-600">
              {translations.sponsorship.mediaPartnersDescription}
            </p>
          </div>
              ...
              <TableBody>
                {mediaPartners.map((partner) => (
                  <TableRow key={partner.id}>
                    ...
                    <TableCell>{getMediaTypeBadge(partner.media_type)}</TableCell>
                    <TableCell>{getCoverageBadge(partner.coverage)}</TableCell>
                    <TableCell>
