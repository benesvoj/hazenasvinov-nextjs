...
import { useSponsorshipData, MainPartner } from "@/hooks/useSponsorshipData";
				...
				<CardHeader>
					<div className="flex justify-between w-full items-center">
						<div>
							...
							<p className="text-sm text-gray-600">{translations.sponsorship.mainPartnersDescription}</p>
						</div>
						<Button 
							color="primary"
							startContent={<PlusIcon className="w-5 h-5" />}
										...
										<TableRow key={partner.id}>
											...
											<TableCell>
												<div className="text-sm">
													<div>{formatDate(partner.start_date)} - {formatDate(partner.end_date)}</div>
												</div>
											</TableCell>
											<TableCell>
