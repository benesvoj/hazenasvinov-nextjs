          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {filteredClubs.map((club) => (
                <div key={club.id} className="border rounded-lg p-4 bg-white shadow-sm hover:shadow-md transition-shadow">
              ...
              {filteredClubs.length === 0 && (
                <div className="text-center py-8 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                  ...
                  <p className="text-gray-500">
                    {searchTerm ? 'Zkuste změnit vyhledávací termín' : 'Začněte přidáním prvního klubu'}
                  </p>
                </div>
              )}
            </div>
