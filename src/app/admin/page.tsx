...
import {AdminContainer, CommentsZone, DeleteDialog, Grid, LoadingSpinner, showToast, ToDoList,} from '@/components';
...
import {CommentModal, TodoModal, TodoStatsList} from './components';
...
export default function AdminDashboard() {
	...
	return (
		<>
			<AdminContainer>
				<TodoStatsList stats={todoStats} todoFilter={todoFilter} setTodoFilter={setTodoFilter}/>
			...
			<DeleteDialog
				...
				message={translations.common.dialog.delete.message(deleteModal.selectedItem?.title || '')}
			/>
		</>
	);
}
