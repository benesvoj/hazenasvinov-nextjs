					...
					{(onClose) => (
						<>
							<Form onSubmit={handleSubmit}>
								...
								<ModalFooter>
									<Button color={'secondary'} onPress={onClose}>{translations.button.cancel}</Button>
									<Button type='submit' color={'primary'} isLoading={loading}>{translations.button.save}</Button>
								</ModalFooter>
							</Form>
						</>
					)}
...
function renderCategoryCell(item: CategoryProps, columnKey: React.Key) {
