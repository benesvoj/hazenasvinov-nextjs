-- Complete cleanup and recreation of training_sessions functions
-- This script drops ALL possible variations and recreates them cleanly
-- Run this in your Supabase SQL Editor

-- Step 1: Drop ALL possible variations of the functions
DO $$ 
DECLARE
    func_record RECORD;
BEGIN
