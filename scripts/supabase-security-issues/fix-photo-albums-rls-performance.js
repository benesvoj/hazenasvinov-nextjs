...
async function fixPhotoAlbumsRLSPerformance() {
  console.log('🔧 Fixing photo_albums RLS performance issue...');
  console.log('');

  try {
    // Read the SQL script
    const sqlPath = path.join(process.cwd(), 'fix_photo_albums_rls_performance.sql');
    ...
    console.log('   • Fixed photo_albums table RLS policies');
    console.log('   • Fixed photos table RLS policies for consistency');
    ...
    console.log('   • Better user experience with faster queries');
    console.log('');
    ...
    console.error('   2. Copy and paste the contents of scripts/fix_photo_albums_rls_performance.sql');
