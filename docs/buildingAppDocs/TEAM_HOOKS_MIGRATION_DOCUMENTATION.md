...
- `src/app/admin/matches/error.tsx.backup` - Uses `fetchTeams` for team data fetching
- `src/app/coaches/matches/error.tsx.backup` - Uses `teams` array for match management
...
**Files Using This Hook**:
- `src/app/admin/matches/error.tsx.backup` - Uses `filteredTeams`, `fetchFilteredTeams`, and `clearTeams`
- `src/app/coaches/matches/error.tsx.backup` - Uses filtered team data for match management
...
**Files Using This Hook**:
- `src/app/admin/matches/error.tsx.backup` - Uses `teamCounts`, `loading`, and `fetchTeamCounts`
...
**Files Using This Hook**:
- `src/app/admin/matches/error.tsx.backup` - Uses `clubId` and `isOwnClub` for match management
