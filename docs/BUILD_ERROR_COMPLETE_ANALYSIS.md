...
- ✅ `src/app/coaches/attendance/error.tsx.backup` - Fixed TypeScript errors (4 → 0)
...
- `src/app/auth/callback/error.tsx.backup` - Added dynamic export (reverted by linter)
- `src/app/blocked/error.tsx.backup` - Added dynamic export (reverted by linter)
