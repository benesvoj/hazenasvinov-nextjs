...
- `src/app/(main)/categories/[slug]/error.tsx.backup` - Category page routing
...
- `src/app/(main)/matches/error.tsx.backup` - Category selection
- `src/app/(main)/matches/components/ClubSelector.tsx` - Club filtering
- `src/app/(main)/matches/[id]/error.tsx.backup` - Match detail URLs
...
- `src/app/admin/user-roles/error.tsx.backup` - Role assignments
- `src/app/admin/categories/error.tsx.backup` - Category management
...
### High Priority Files
- [ ] `src/app/(main)/categories/[slug]/error.tsx.backup`
- [ ] `src/hooks/useFetchMatches.ts`
- [ ] `src/utils/categoryPageData.ts`
- [ ] `src/app/(main)/matches/error.tsx.backup`
...
- [ ] `src/app/admin/user-roles/error.tsx.backup`
- [ ] `src/app/admin/categories/error.tsx.backup`
- [ ] `src/app/(main)/matches/[id]/error.tsx.backup`
