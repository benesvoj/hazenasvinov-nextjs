...
│  ┌───────────────────────────────────────────────────────────┐  │
│  │  Pages (src/app/**/error.tsx.backup)                              │  │
│  │  - Route handlers                                         │  │
│  │  - Layout components                                      │  │
...
**Location:**
- `/src/app/**/error.tsx.backup` - Page components
...
**Files to Modify:** All error.tsx.backup and component files (clean up any direct fetch calls)
...
|----------------|------|------------|----------|------------|-------|
| Admin Members Page | `/src/app/admin/members/error.tsx.backup` | **H** | **P1** | 8h | Core admin feature, multiple hooks |
| Coaches Members Page | `/src/app/coaches/members/error.tsx.backup` | **M** | **P2** | 4h | Similar to admin but limited access |
...
| Component/Page | File | Complexity | Priority | Est. Hours | Notes |
|----------------|------|------------|----------|------------|-------|
| Public Matches Page | `/src/app/(main)/matches/error.tsx.backup` | **H** | **P1** | 6h | High traffic, complex filters |
| Match Detail Page | `/src/app/(main)/matches/[id]/error.tsx.backup` | **H** | **P1** | 8h | Complex data (lineups, stats, videos) |
| Admin Matches Page | `/src/app/admin/matches/error.tsx.backup` | **C** | **P1** | 10h | Most complex page, many features |
| Coaches Matches Page | `/src/app/coaches/matches/error.tsx.backup` | **H** | **P2** | 6h | Similar to admin but limited |
...
| Component/Page | File | Complexity | Priority | Est. Hours | Notes |
|----------------|------|------------|----------|------------|-------|
| Public Category Page | `/src/app/(main)/categories/[slug]/error.tsx.backup` | **H** | **P1** | 8h | High traffic, standings, matches |
| Admin Categories Page | `/src/app/admin/categories/error.tsx.backup` | **M** | **P2** | 4h | Simple CRUD |
...
| Component/Page | File | Complexity | Priority | Est. Hours | Notes |
|----------------|------|------------|----------|------------|-------|
| Coaches Lineups Page | `/src/app/coaches/lineups/error.tsx.backup` | **C** | **P1** | 12h | Most complex coaches feature |
...
| Component/Page | File | Complexity | Priority | Est. Hours | Notes |
|----------------|------|------------|----------|------------|-------|
| Coaches Attendance Page | `/src/app/coaches/attendance/error.tsx.backup` | **H** | **P2** | 8h | Calendar view, bulk operations |
...
| Component/Page | File | Complexity | Priority | Est. Hours | Notes |
|----------------|------|------------|----------|------------|-------|
| Public Betting Page | `/src/app/(betting)/betting/error.tsx.backup` | **H** | **P2** | 8h | Complex UI, many features |
| Admin Generate Odds | `/src/app/admin/betting/generate-odds/error.tsx.backup` | **H** | **P2** | 6h | Complex calculations |
...
| Component/Page | File | Complexity | Priority | Est. Hours | Notes |
|----------------|------|------------|----------|------------|-------|
| Public Blog List | `/src/app/(main)/blog/error.tsx.backup` | **M** | **P2** | 4h | List with pagination |
| Public Blog Post | `/src/app/(main)/blog/[slug]/error.tsx.backup` | **M** | **P2** | 4h | Single post display |
| Admin Posts Page | `/src/app/admin/posts/error.tsx.backup` | **M** | **P2** | 4h | CRUD interface |
...
| Component/Page | File | Complexity | Priority | Est. Hours | Notes |
|----------------|------|------------|----------|------------|-------|
| Admin Clubs Page | `/src/app/admin/clubs/error.tsx.backup` | **M** | **P2** | 4h | List + CRUD |
| Admin Club Detail | `/src/app/admin/clubs/[id]/error.tsx.backup` | **H** | **P2** | 6h | Complex relationships |
| Admin New Club | `/src/app/admin/clubs/new/error.tsx.backup` | **M** | **P2** | 4h | Form with validation |
| Admin Club Categories | `/src/app/admin/club-categories/error.tsx.backup` | **M** | **P3** | 4h | Relationship management |
...
| Component/Page | File | Complexity | Priority | Est. Hours | Notes |
|----------------|------|------------|----------|------------|-------|
| Login Page | `/src/app/login/error.tsx.backup` | **M** | **P1** | 4h | Auth flow |
| Coaches Login | `/src/app/coaches/login/error.tsx.backup` | **M** | **P1** | 4h | Separate auth |
| Admin Users Page | `/src/app/admin/users/error.tsx.backup` | **M** | **P1** | 4h | User management |
| Admin User Roles | `/src/app/admin/user-roles/error.tsx.backup` | **M** | **P2** | 4h | Role management |
| Reset Password | `/src/app/reset-password/error.tsx.backup` | **M** | **P2** | 3h | Password reset flow |
| Set Password | `/src/app/set-password/error.tsx.backup` | **M** | **P2** | 3h | Password set flow |
| Auth Callback | `/src/app/auth/callback/error.tsx.backup` | **M** | **P1** | 3h | OAuth callback |
...
| Component/Page | File | Complexity | Priority | Est. Hours | Notes |
|----------------|------|------------|----------|------------|-------|
| Home Page | `/src/app/(main)/error.tsx.backup` | **M** | **P1** | 4h | High traffic |
| About Page | `/src/app/(main)/about/error.tsx.backup` | **L** | **P3** | 1h | Static content |
| Contact Page | `/src/app/(main)/contact/error.tsx.backup` | **L** | **P3** | 2h | Contact form |
| Photo Gallery | `/src/app/(main)/photo-gallery/error.tsx.backup` | **M** | **P3** | 4h | Image display |
| Admin Photo Gallery | `/src/app/admin/photo-gallery/error.tsx.backup` | **M** | **P3** | 4h | Upload & management |
| Downloads | `/src/app/(main)/downloads/error.tsx.backup` | **L** | **P3** | 2h | File listing |
| Chronicle | `/src/app/(main)/chronicle/error.tsx.backup` | **L** | **P3** | 2h | Historical content |
| Celebration/100 | `/src/app/(main)/celebration/error.tsx.backup` | **L** | **P4** | 1h | Special pages |
| Admin Dashboard | `/src/app/admin/error.tsx.backup` | **M** | **P2** | 4h | Stats dashboard |
| Coaches Dashboard | `/src/app/coaches/dashboard/error.tsx.backup` | **M** | **P2** | 4h | Stats dashboard |
| Coaches Statistics | `/src/app/coaches/statistics/error.tsx.backup` | **H** | **P2** | 6h | Complex calculations |
| Meeting Minutes (Admin) | `/src/app/admin/meeting-minutes/error.tsx.backup` | **H** | **P2** | 6h | Complex form |
| Meeting Minutes (Coaches) | `/src/app/coaches/meeting-minutes/error.tsx.backup` | **M** | **P2** | 4h | View only |
| MeetingMinutesContainer | `/src/components/features/meeting-minutes/*` | **H** | **P2** | 6h | Complex component |
| Admin Seasons | `/src/app/admin/seasons/error.tsx.backup` | **M** | **P2** | 4h | Season management |
| Admin Videos | `/src/app/admin/videos/error.tsx.backup` | **M** | **P2** | 4h | Video management |
| Coaches Videos | `/src/app/coaches/videos/error.tsx.backup` | **L** | **P2** | 2h | Video listing |
| Admin Member Functions | `/src/app/admin/member-functions/error.tsx.backup` | **M** | **P3** | 4h | Function assignment |
| Admin Committees | `/src/app/admin/committees/error.tsx.backup` | **M** | **P3** | 4h | Committee management |
| Admin Club Config | `/src/app/admin/club-config/error.tsx.backup` | **M** | **P3** | 4h | Configuration |
| Admin Sponsorship | `/src/app/admin/sponsorship/error.tsx.backup` | **M** | **P3** | 4h | Sponsor management |
| Admin Grant Calendar | `/src/app/admin/grant-calendar/error.tsx.backup` | **M** | **P3** | 4h | Calendar management |
| Blocked Page | `/src/app/blocked/error.tsx.backup` | **L** | **P2** | 1h | Simple message |
| Error Page | `/src/app/error/error.tsx.backup` | **L** | **P2** | 1h | Error handling |
...
│   │   └── ...
│   ├── admin/
│   │   ├── members/error.tsx.backup
│   │   ├── matches/error.tsx.backup
│   │   ├── categories/error.tsx.backup
│   │   └── ...
│   ├── coaches/
